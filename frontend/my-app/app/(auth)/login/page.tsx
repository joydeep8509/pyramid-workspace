      ...
      <div className="w-full max-w-[400px] flex flex-col items-center">
        ...
        <div className="w-full bg-white dark:bg-[#09090b] border border-[#e4e4e7] dark:border-[#27272a] rounded-[24px] p-8 shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)] text-center">
          ...
          <div className="space-y-3">
            <button type="button" onClick={handleLogin} className="w-full bg-[#09090b] dark:bg-white text-white dark:text-black text-[14px] font-medium py-[11px] rounded-full hover:bg-black/80 dark:hover:bg-white/80 transition-colors">
              Continue as Guest
            </button>
            <button type="button" onClick={handleLogin} className="w-full bg-white dark:bg-[#09090b] text-foreground border border-[#e4e4e7] dark:border-[#27272a] text-[14px] font-medium py-[11px] rounded-full hover:bg-[#fafafa] dark:hover:bg-[#18181b] transition-colors flex items-center justify-center gap-2.5">
